<?php
$_lang['area_sitestatistics_main'] = 'Основные';

$_lang['setting_stat.online_time'] = 'Время присутствия на сайте.';
$_lang['setting_stat.online_time_desc'] = 'Время (в минутах), по истечении которого будет считаться, что пользователь ушел.';
$_lang['setting_stat.enable_statistics'] = 'Включить ведение статистики';
